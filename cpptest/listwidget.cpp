...
template<typename T>
void ListWidget::arr_searchTest(const T& container)
{
    int item;
    size_t index;
    clock_t begin = clock();
...
template<typename T>
void ListWidget::vec_insertTest(T& container)
{
    int item;
    size_t index;
    clock_t begin = clock();
...
template<typename T>
void ListWidget::list_searchTest(const T& container)
{
    int item;
    size_t index;
    clock_t begin = clock();
...
template<typename T>
void ListWidget::list_insertTest(T& container)
{
    int item;
    clock_t begin = clock();
    for(int i = 0; i < N; i++){
...
template<typename T>
void ListWidget::list_deleteTest(T& container)
{
    clock_t begin = clock();
    for(int i = 0; i < N; i++){
        container.pop_front();
